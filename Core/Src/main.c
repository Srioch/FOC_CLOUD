...
static volatile uint8_t telemetry_task_pending = 0U;
static volatile uint8_t vision_task_pending = 0U;
/* USER CODE END PV */
...
int main(void)
{
  ...
  while (1)
  {
    ...
    if (vision_task_pending != 0U)
    {
      vision_task_pending = 0U;
    ...
    if (telemetry_task_pending != 0U)
    {
      telemetry_task_pending = 0U;
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  if (htim->Instance == TIM1)
  {
    ...
    {
      timercount = 0U;
      telemetry_task_pending = 1U;
    }

    if (++vision_counter >= 5U)
    {
      vision_counter = 0U;
      vision_task_pending = 1U;
    }
  }
}
/* USER CODE END 4 */
